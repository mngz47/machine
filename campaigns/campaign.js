...
e('campaigns').innerHTML += '<a href="https://t.me/share/url?url=https://bit.ly/48GtBaZ&text='+campaign["title"]+','+campaign["audio"]+','+campaign["allowed content"]+'" target="_blank">Share on Telegram</a>-<a onclick="navigator.clipboard.writeText(parent.innerHTML);return false;" >Copy</a>';
